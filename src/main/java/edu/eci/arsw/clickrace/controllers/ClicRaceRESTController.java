...
public class ClicRaceRESTController {
    ...
    public ResponseEntity<?> getWinner(@PathVariable String racenum,@RequestBody RaceParticipant rp){
        System.out.println("xd "+rp.getNumber());
        try{
            int participant = services.getWinner(Integer.parseInt(racenum),rp);
